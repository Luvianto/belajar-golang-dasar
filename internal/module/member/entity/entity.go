...
type Member struct {
	...
	User entity.User `gorm:"foreignKey:UserID;references:UUID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
	commonModels.TimestampsSoftDelete
}

type MemberCreate struct {
	User              entity.UserCreate `json:"user" validate:"required"`
